...
os.environ['TORCH_HOME'] = '/data/cmpe258-Spring2024/torchhome/' #setting the environment variable
...
parser.add_argument('--data_path', type=str, default="/data/cmpe-258-Spring24/v2-plant-seedlings-dataset",
